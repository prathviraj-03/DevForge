    ...
    <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 16, padding: "40px 36px" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="form-row">
          <div>
            <label style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", display: "block", marginBottom: 6, fontFamily: "'Outfit', sans-serif" }}>Your Name *</label>
            <input className="form-input" name="name" required value={form.name} onChange={handleChange} placeholder="Rahul Sharma" />
          </div>
          <div>
            <label style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", display: "block", marginBottom: 6, fontFamily: "'Outfit', sans-serif" }}>Email Address *</label>
            <input className="form-input" name="email" type="email" required value={form.email} onChange={handleChange} placeholder="rahul@startup.com" />
          </div>
        </div>

        <div>
          <label style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", display: "block", marginBottom: 6, fontFamily: "'Outfit', sans-serif" }}>Project Budget</label>
        ...
        <div>
          <label style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", display: "block", marginBottom: 6, fontFamily: "'Outfit', sans-serif" }}>Tell us about your project *</label>
          <textarea
        ...
        <p style={{ textAlign: "center", color: "var(--text-muted)", fontSize: 12 }}>
          ...
          <a href={`mailto:${contact.email}`} style={{ color: "var(--amber)", textDecoration: "none" }}>{contact.email}</a>
        </p>
      </form>
