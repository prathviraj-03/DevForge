        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 32, marginBottom: 40 }}
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <BrandLogo showIcon={false} style={{ fontSize: 17, color: "var(--text-primary)" }} textStyle={{ fontSize: 17 }} />
            </div>
            ...
            <a href={contact.whatsapp} target="_blank" rel="noopener noreferrer" style={{
              ...
              color: "var(--amber)", padding: "9px 16px", borderRadius: 8,
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 10 }}>
              {siteData.services.slice(0, 3).map((s) => (
                <li key={s.title}>
